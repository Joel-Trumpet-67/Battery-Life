...
const TILES = [
  ...
  // { id: 'opr',        icon: '📊', label: 'OPR / DPR',   sub: 'Power ratings' },
  // { id: 'headtohead', icon: '⚔️',  label: 'Head to Head', sub: 'Compare two teams' },
  // { id: 'bracket',    icon: '🏅', label: 'Bracket',      sub: 'Playoff results' },
